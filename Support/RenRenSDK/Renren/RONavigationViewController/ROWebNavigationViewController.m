...
//        UIButton *closeButton = [UIHelper createLeftBarButton:@"icon_close.png"];
...
- (void)viewDidLoad
{
    ...
    self.webView = [[[UIWebView alloc] initWithFrame:CGRectMake(0, 0, 460, 453)] autorelease];
    ...
    self.indicatorView.center = CGPointMake(460 / 2, 453 / 2);
